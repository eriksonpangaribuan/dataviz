...
<img src="005_animasi-grafik_files/figure-gfm/animate-temperature-2.png" style="display: block; margin: auto;" />
...
animate_weather <- 
  ...
  labs(
    ...
    y = "Tekanan Udara (Bar)",
    title = "Grafik Cuaca Kota Bandung",
    subtitle = "Lokasi pengamatan: {closest_state}",
    caption = "Grafik ini dibuat oleh Erikson Pangaribuan",
